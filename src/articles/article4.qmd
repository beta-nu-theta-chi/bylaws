...
1. Unless specified in Article IV, Section B, or explicitly voted on by {{< var glossary.simple-majority >}}, the method of voting will be by a counted show of hands.
...
1. The following votes will be performed by ballot:
   ...
   b. Officer Elections
   c. To overturn an Executive Council ({{< var acronyms.ec >}}) Interpretation of the bylaws (Article I, Section D)
