...
1. Vice President
   ...
   a. May make Ad Hoc Committees at their discretion as defined in @sec-art-VI2T9PVL, Item 3a.
   a. Must live in the house.
...
1. Recruitment Chair
   ...
   a. Confirms and tracks the attendance of each brother at Rush events (@sec-art-0ERS31Z3, Item 2).
   a. Serves as a member of {{< var acronyms.ec >}}.
   a. Must live in the house.
...
1. Philanthropy Chair
   a. Serves as chair of the Philanthropy Committee.
   a. Ensures the chapter meets the Greek Life goals for philanthropy.
   a. Informs the chapter of philanthropy opportunities.
   a. Responsible for planning and holding one philanthropy event per semester.
   a. Responsible for having one philanthropy event per academic year benefit the USO.
   a. Serves as a member of {{< var acronyms.ccc >}}.

1. Service Chair
   a. Serves as chair of the Service Committee.
   a. Ensures the chapter meets the Greek Life goals for service.
   a. Informs the chapter of service opportunities.
   a. Responsible for planning and holding at least one service event for the chapter per semester.
   a. Responsible for tracking the service hours of active brothers.
   a. Serves as a member of {{< var acronyms.ccc >}}.
...
1. Diversity, Equity, and Inclusion Chair
   a. {{< var glossary.attend >}}s all Diversity, Equity, and Inclusion roundtables hosted by the Greek Life Office.

1. Greek Games Chair
   a. Organizes the chapter's participation in Greek Week.
   a. {{< var glossary.attend >}}s Greek Week Chair meetings sponsored by the Greek Week Steering Committee.
   a. Appoints brothers to captain Greek Week events.
...
1. Purpose, Duties, and Powers
   ...
   a. Reviews appeals to {{< var glossary.bad-academic-standing >}} as defined in @sec-art-1UWTGO5I.
...
1. Voting
   a. Voting Members
      ...
      i. Recruitment Chair
      i. Scholarship Chair
   a. {{< var glossary.quorum >}} will consist of at least five members, at least four of whom must be voting members.
   a. All votes are decided by an {{< var glossary.absolute-majority >}} of {{< var acronyms.ec >}}.
...
1. The chapter will have the following groups of committees:
   a. Standard Committees
      ...
      i. The list of Standard committees is as follows:
         1. Alumni Relations Committee
         1. Member Development Committee
