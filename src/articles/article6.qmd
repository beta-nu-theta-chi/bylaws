...
1. The Treasurer will present a preliminary budget to the Budget Committee (@sec-art-VI2T9PVL, Item 2c)  and CAB Treasurer Advisor no later than one month before the end of the previous semester.
...
1. Brothers will pay all dues and other financial obligations to the chapter as defined in the budget.
   a. Brothers will pay all financial obligations through either a physical check made out to “Beta Nu Chapter Theta Chi Fraternity” or a wireless transfer/eCheck.
   a. A brother who pays via other methods (i.e. credit card or Apple Pay) may be subject to a fine of up to 5% of the original paid amount, to be determined by the treasurer.
      i. If a brother wishes to bypass this fee, they must submit a deferment to be approved via @sec-art-OUD16M61, Item 3.
...
## Financial Privacy {#sec-art-KK0JMIWX}

1. {{< var acronyms.ec >}} and {{< var acronyms.cab >}} will have the right to request access to all accounts, budgeting and financial software, the current ledger, and Greek Bill, excluding bank accounts, subject to the discretion of the treasurer and CAB Treasurer Advisor.
1. {{< var acronyms.ec >}} and {{< var acronyms.cab >}} will have the right to request access to any records or statements from the bank account (or whatever online service is currently being used).
1. Only the President, Treasurer, and CAB Treasurer Advisor will have access to the bank accounts.
...
1. A member who would like to obtain a reimbursement needs approval from all of the following:
   ...
   a. The chair who controls the budget in question.
      i. If the budget is not under a particular chair, or the chair is indisposed, any non-treasurer member of {{< var acronyms.ec >}} may act as a substitute.
