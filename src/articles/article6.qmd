...
2. {{< var acronyms.ec >}} and {{< var acronyms.cab >}} will have the right to request access to any records or statements from the bank account (or whatever online service is currently being used).
3. Only the President, Treasurer, and CAB Treasurer Advisor will have access to the bank accounts.
