...
1. {{< var acronyms.ec >}} will have the power to interpret these Bylaws by an {{< var glossary.absolute-majority >}} vote.
1. Any brother may bring {{< var acronyms.ec >}} Bylaw Interpretation {{< var glossary.grievance >}}s, in writing, to {{< var acronyms.ec >}}.
   ...
   a. The results of the {{< var glossary.grievance >}}s will be announced to the chapter at the next chapter meeting.
      i. {{< var acronyms.ec >}} interpretation is subject to overrule by a {{< var glossary.supermajority >}} vote of the active chapter.
1. Voting to overrule an {{< var acronyms.ec >}} interpretation of these Bylaws will be done by {{< var glossary.ballot >}}.
