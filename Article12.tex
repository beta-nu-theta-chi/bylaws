...
\section{Hearing Preparation}
	...
	\begin{enumerate}
		\item Evidence and a statement by the anonymous accuser will be distributed by the Arbiter between twenty-four and forty-eight hours before the trial date and time.
		...
		\item The Arbiter will call the hearing to order and ask all but the directly related participants to leave the room. The directly related participants are the Arbiter, Scribe, Parliamentarian, Justices, and accused.
	\end{enumerate}

\section{Hearing Method}
	\begin{enumerate}
		\item The arbiter reads aloud the charges and ensures that the accused understands the charges.
		\item The accused may give an opening statement with a time limit as voted on by the board.
		\item The accused may then be asked questions by the board with a time limit as voted on by the board.
		\item All witnesses will be brought into the room by the Arbiter.
		\item Witnesses that wish to speak for the charges will be chosen in an order decided by the Arbiter to give a statement. The accused and the justices will ask questions of the witness(es) with a time limit as voted on by the board.
		\item Witnesses that wish to speak against the charges will be chosen in an order decided by the Arbiter to give a statement. The accused and the justices will ask questions of the witness(es) with a time limit as voted on by the board.
		\item All witnesses will be excused by the Arbiter.
		\item The accused may give a closing statement with a time limit as voted on by the board.
		\item The Arbiter will excuse the accused from the hearing.
		\item The board will then determine appropriate sanctions, if any.
			\begin{enumerate}
			...
			\end{enumerate}
		\item After the sanctions have been determined the Arbiter will readmit the accused back to the hearing and will announce the sanctions given, if any.
...
\section{Sanctions}
	\begin{enumerate}
		\item The board may issue sanctions within its limited scope. The following are suggested examples of possible sanctions:
			\begin{enumerate}
				\item Community Service
				\item Cost of repairs
				\item Fines
				\item House Service
				\item Letter of Apology
				\item Removal from an Appointed Position
			\end{enumerate}
