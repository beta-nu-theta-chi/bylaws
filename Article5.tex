...
\section{Terms of Office}
	\begin{enumerate}
		...
		\item The Recruitment Chair and Public Relations Chair will serve from the end of the first \gls{rush} period after election or appointment through the first \gls{rush} period after the election or appointment of a new officer.
	\end{enumerate}
...
\section{Elections}
    ...
    \item Standards Board elections will proceed as such:
	    ...
	    \item The election will be held by \gls{ranked-choice} voting system.
...
elections will be interpreted as CAB waiving their right to interview the candidate.
		...
		\item Marshal
			...
			\begin{enumerate}
				...
				\item Will present a \gls{rush} calendar to the chapter by Initiation.
