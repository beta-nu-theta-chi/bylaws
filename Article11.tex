	...
	\begin{enumerate}
		...
		\item Rush
			\begin{enumerate}
				...
				\item Brothers will \gls{attend} an amount of \gls{rush} events as specified by the Rush Plan.
			\end{enumerate}
		...
		\item Service
			\begin{enumerate}
				\item Brothers will complete the service hours assigned to them by the Philanthropy and Service Chair.
			\end{enumerate}
		...
		\item Committees
			\begin{enumerate}
				...
				\item Brothers will attend assigned committee meetings as outlined in \hyperref[committees]{Article V, \autoref*{committees}}.
			\end{enumerate}
